...
// Versão do Exercício 4 que fica rodando: ao final de cada aluno,
// pergunta "Deseja calcular outro? (S/N)". Enquanto a resposta for S,
// processa um novo aluno; caso contrário, encerra.
...
FUNCTION Main()
   ...
   QOut(" ")
   QOut("Encerrado. Até a próxima!")

RETURN NIL

// -----------------------------------------------------------------
// Lê, valida e exibe os dados de um aluno (mesma lógica do Ex. 4)
// -----------------------------------------------------------------
